...
export class Basket {
    ...
    constructor(container: HTMLElement, ordercontainer: ICardsContainer, events: IEvents) {
        this.container = container;
        this.orderList = ordercontainer;
        this.events = events;
        this.priceBasket = ensureElement<HTMLElement>('.basket__price', this.container)
